...
<body>
    ...
    <div class="shadow">
        <div class="container">
            <p id="fcfs">FCFS is the simplest disk scheduling algorithm. As the name suggests, this algorithm entertains requests in the order they arrive in the disk queue. The algorithm looks very fair and there is no starvation (all requests are serviced sequentially)
                but generally, it does not provide the fastest service.</p>
    ...
    <div class="container">
        &nbsp;&nbsp; <input type="text" id="text1" placeholder="Enter order of request sequence : "></input> &nbsp; &nbsp; <input type="button" class="button" id="button1" value="Add" onclick="add_element_to_array()"></input>
    ...
    <script>
        ...
        q.setAttribute("class", "_classmytable");
