    ...
    <style>
        * {
        ...
        .login-div {
            ...
            border-radius: 40px;
            background-color: #ecf0f3;
            box-shadow: 13px 13px 20px #50e5b9, -13px -13px 20px #fff;
            margin-top: 20px;
        }
        ...
        <div class="home ">
            <div class="login-div ">
                ...
                <div class="fields ">
                    ...
                    <div class="username ">
                        <input type="username " name="email" class="user-input " placeholder="Email ID " />
                    </div>
                    <div class="password ">
                        <input type="password " name="password" class="pass-input " placeholder="Password " />
                    </div>
                    <button class="signin-button " name="submit">SignUp</button>
                    <div class="link ">
                        <a href="# ">Forgot password? </a> or <a href="login.php "> Login</a>
                    </div>
                </div>
            </div>
        </div>
